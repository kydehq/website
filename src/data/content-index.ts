...
export type Article = {
  ...
  readTime?: string;
  live?: boolean;
  /** ISO publication date. Dated entries are the ones the RSS feed carries;
   *  the guides and research notes are undated on purpose, because they hang
   *  off regulation rather than off news. */
  date?: string;
};
